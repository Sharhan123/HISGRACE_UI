    ...
    <h1 className='text-center kanit-regular'>Select your location</h1>
      ...
      <div className="relative flex items-center mt-4 md:mt-0">
                ...
                <div className="relative w-full min-w-[320px] h-10">
                            ...
                            <label className="flex w-full h-full select-none pointer-events-none absolute left-0 font-normal peer-placeholder-shown:text-gray-500 leading-tight peer-focus:leading-tight
                             peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm 
                             text-[11px] peer-focus:text-[11px] before:content[' '] before:block before:box-border before:w-2.5 before:h-1.5 before:mt-[6.5px] 
