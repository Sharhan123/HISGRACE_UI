...
const RecordTable: React.FC = () => {
    ...
    const handleFilter = (value: string) => {
        const arr = data?.filter((item) => item.type === value)
        if (arr) {
                                ...
                                <table className="min-w-full   divide-y  divide-gray-200 ">
                                    <thead className="bg-gray-100  ">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3.5 text-lg kanit-medium font-normal text-center rtl:text-right text-black ">Price/KM</th>
                                                ...
                                                <tr key={index}>
                                                    <td className="px-4 py-4 text-sm font-medium text-center whitespace-nowrap">
                                                        <div className="relative w-12 h-12">
                                                            <img src={item.images} alt="Innova" className="w-full h-full object-cover rounded-md" />
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm font-medium text-center whitespace-nowrap">
                                                        <div>
                                                            <h2 className="text-xl kanit-regular text-black">{item.vehicleName}</h2>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap text-center">
                                                        <div>
                                                            <h2 className="text-xl kanit-regular text-black">₹ {item.price}</h2>
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap text-center">
                                                        <div>
                                                            <h2 className="text-xl kanit-regular text-green-600">₹ {item.startingPrice}</h2>
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap text-center">
                                                        <div>
                                                    ...
                                                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap text-center">
                                                        <div>
                                                            <button className="text-md w-20 h-8 rounded-md bg-red-800 kanit-regular text-white">
                                                                <DeleteItemModal onDelete={() => onDelete(item.id)} itemName='vehicle' />
                                                            </button>
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap text-center">
